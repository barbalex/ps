...
- docs need to exist in de, en, fr and it. They will be written in either de or en. the language version is added to the file name. The metadata contains the label in four versions, fallback is label_de
