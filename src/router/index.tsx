                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      lazy: () =>
                        import('../routes/occurrenceImport/index.tsx'),
                      handle: {
                        crumb: {
                          table: 'occurrence_imports',
                          folder: false,
                      ...
                      children: [
                        {
                          index: true,
                          lazy: () =>
                            import('../routes/subprojectReport/Form.tsx'),
                        },
                      ],
                    },
                    {
                      ...
                      lazy: () =>
                        import('../routes/subprojectReport/index.tsx'),
                      handle: {
                        crumb: {
                          table: 'subproject_reports',
                          folder: false,
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    ...
                    {
                      path: ':list_value_id',
                      lazy: () => import('../routes/listValue/index.tsx'),
                      handle: {
                        crumb: {
                          table: 'list_values',
                          folder: false,
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  index: true,
                  lazy: () => import('../routes/vectorLayer/Form/index.tsx'),
                },
              ],
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    {
                      index: true,
                      lazy: () => import('../routes/vectorLayerDisplays.tsx'),
                    },
                    {
                      path: ':vector_layer_display_id',
                      lazy: () =>
                        import('../routes/vectorLayerDisplay/index.tsx'),
                      handle: {
                        crumb: {
                          table: 'vector_layer_displays',
                          folder: false,
