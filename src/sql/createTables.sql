...
CREATE TABLE users(
  user_id uuid PRIMARY KEY DEFAULT gen_random_uuid() -- public.uuid_generate_v7() not supported by electric-sql
  ...
  deleted boolean DEFAULT NULL -- electric does not support boolean default false
);
