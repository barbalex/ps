...
export const PlaceReportQuantity = ({ from }) => {
  const { placeReportQuantityId, projectId } = useParams({ from })
    ...
    <div className="form-outer-container">
      ...
      <div className="form-container">
        {!res ? (
          ...
          <NotFound table="Place Report Quantity" id={placeReportQuantityId} />
        )}
      </div>
    </div>
  )
