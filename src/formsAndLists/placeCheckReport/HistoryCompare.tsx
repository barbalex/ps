...
import type PlaceCheckReportsHistory from '../../models/public/PlaceCheckReportsHistory.ts'

export const PlaceCheckReportHistoryCompare = ({
  from,
}: {
  from:
    ...
    | '/data/projects/$projectId_/subprojects/$subprojectId_/places/$placeId_/places/$placeId2_/check-reports/$placeCheckReportId_/histories/$placeCheckReportHistoryId'
}) => {
  ...
  const reportPath = placeId2
    ? `/data/projects/${projectId}/subprojects/${subprojectId}/places/${placeId}/places/${placeId2}/check-reports/${placeCheckReportId}/report`
    : `/data/projects/${projectId}/subprojects/${subprojectId}/places/${placeId}/check-reports/${placeCheckReportId}/report`

  const historyPath = placeId2
    ? `/data/projects/${projectId}/subprojects/${subprojectId}/places/${placeId}/places/${placeId2}/check-reports/${placeCheckReportId}/histories`
    : `/data/projects/${projectId}/subprojects/${subprojectId}/places/${placeId}/check-reports/${placeCheckReportId}/histories`
  ...
  return (
    <HistoryCompare<PlaceCheckReportsHistory>
      ...
      historyConfig={{
        ...
        rowId: placeCheckReportId,
        historyPath,
        routeHistoryId: placeCheckReportHistoryId,
        currentRow: row,
      }}
      restoreConfig={{
        db,
