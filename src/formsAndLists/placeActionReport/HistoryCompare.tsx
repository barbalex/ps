...
export const PlaceActionReportHistoryCompare = ({
  from,
}: {
  from:
    ...
    | '/data/projects/$projectId_/subprojects/$subprojectId_/places/$placeId_/places/$placeId2_/action-reports/$placeActionReportId_/histories/$placeActionReportHistoryId'
}) => {
  ...
  return (
    <HistoryCompare<PlaceActionReportsHistory>
      ...
      historyConfig={{
        ...
        rowId: placeActionReportId,
        historyPath,
        routeHistoryId: placeActionReportHistoryId,
        currentRow: row,
      }}
      restoreConfig={{
        db,
