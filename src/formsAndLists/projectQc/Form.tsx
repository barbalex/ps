    ...
    <>
      ...
      >
        <SectionDescription>
          {formatMessage(
            {
              id: 'projectQc.section.query.description',
              defaultMessage:
                'Die Abfrage soll verdächtige Datensätze aufdecken. Sie retourniert zwei Felder: label (Beschriftung) und url (ein Link um den Datensatz aufzurufen). Beispiele findest du bei den <link>vorbereiteten Qualitätskontrollen</link>.',
            },
            {
              link: (chunks) => (
