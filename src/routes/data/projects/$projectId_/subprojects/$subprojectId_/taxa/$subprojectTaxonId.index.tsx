...
import { SubprojectTaxon } from '../../../../../../../formsAndLists/subprojectTaxon'

export const Route = createFileRoute('/data/projects/$projectId_/subprojects/$subprojectId_/taxa/$subprojectTaxonId/')({
  component: () => (
