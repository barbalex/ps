...
export const Route = createFileRoute(from)({
  component: () => (
    <PlaceCheckReportQuantity from="/data/projects/$projectId_/subprojects/$subprojectId_/places/$placeId_/check-reports/$placeReportId_/quantities/$placeReportQuantityId/" />
  ),
  beforeLoad: ({ params }) => {
