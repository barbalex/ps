...
const from =
  '/data/projects/$projectId_/subprojects/$subprojectId_/places/$placeId_/action-reports/$placeActionReportId_/quantities/$placeActionReportQuantityId/'

export const Route = createFileRoute(from)({
  component: () => (
    <PlaceActionReportQuantity from="/data/projects/$projectId_/subprojects/$subprojectId_/places/$placeId_/action-reports/$placeActionReportId_/quantities/$placeActionReportQuantityId/" />
  ),
  beforeLoad: ({ params }) => {
