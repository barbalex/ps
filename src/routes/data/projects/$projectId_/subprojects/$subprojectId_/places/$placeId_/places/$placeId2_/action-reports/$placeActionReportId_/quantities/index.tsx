...
export const Route = createFileRoute(from)({
  component: () => (
    <PlaceActionReportQuantities from="/data/projects/$projectId_/subprojects/$subprojectId_/places/$placeId_/places/$placeId2_/action-reports/$placeActionReportId_/quantities/" hideTitle={true} />
  ),
