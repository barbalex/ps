...
export const Route = createFileRoute(from)({
  component: () => (
    <PlaceReportQuantity from="/data/projects/$projectId_/subprojects/$subprojectId_/places/$placeId_/places/$placeId2_/reports/$placeReportId_/quantities/$placeReportQuantityId/" />
  ),
  beforeLoad: ({ params }) => {
