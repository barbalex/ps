...
const from =
  '/data/projects/$projectId_/subprojects/$subprojectId_/places/$placeId_/checks/$checkId_/reports/$checkReportId_/quantities/$checkReportQuantityId/'

export const Route = createFileRoute(from)({
  component: () => (
    <CheckReportQuantity from="/data/projects/$projectId_/subprojects/$subprojectId_/places/$placeId_/checks/$checkId_/reports/$checkReportId_/quantities/$checkReportQuantityId/" />
  ),
  beforeLoad: ({ params }) => {
