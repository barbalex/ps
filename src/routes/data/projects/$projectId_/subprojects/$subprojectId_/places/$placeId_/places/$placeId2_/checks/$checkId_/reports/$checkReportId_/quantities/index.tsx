...
export const Route = createFileRoute(from)({
  component: () => (
    <CheckReportQuantities from="/data/projects/$projectId_/subprojects/$subprojectId_/places/$placeId_/places/$placeId2_/checks/$checkId_/reports/$checkReportId_/quantities/" />
  ),
