...
export const Route = createFileRoute(from)({
  component: () => (
    <PlaceCheckReportQuantities
      from="/data/projects/$projectId_/subprojects/$subprojectId_/places/$placeId_/places/$placeId2_/check-reports/$placeCheckReportId_/quantities/"
      hideTitle={true}
    />
  ),
