...
import { SubprojectReport } from '../../../../../../../formsAndLists/subprojectReport'

export const Route = createFileRoute('/data/projects/$projectId_/subprojects/$subprojectId_/reports/$subprojectReportId/')({
  component: () => (
