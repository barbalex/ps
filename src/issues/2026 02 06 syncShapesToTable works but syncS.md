...
My app (https://github.com/barbalex/ps) contains 58 tables (https://github.com/barbalex/ps/blob/b2ed0d81bf30370023e286e31f4ea625e636300c/backend/db/init/03_createTables.sql) and a few dozen triggers.
...
I unfortunately do not know how to try to get syncing to work. The only Alternative I can see is to sync the data into IndexedDB where relations, triggers and more is not enforced.
