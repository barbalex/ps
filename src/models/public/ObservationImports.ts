...
import type { OccurrenceImportsGeometryMethodsGeometryMethod } from './ObservationImportsGeometryMethods'

/** Identifier type for public.observation_imports */
export type OccurrenceImportsOccurrenceImportId = string & {
  __brand: 'public.observation_imports'
}
...
export default interface OccurrenceImports {
  observation_import_id: OccurrenceImportsOccurrenceImportId
