...
import { PlaceActionReportQuantitiesFetcher } from './PlaceActionReportQuantitiesFetcher.tsx'
import { PlaceActionReportQuantityFetcher } from './PlaceActionReportQuantityFetcher.tsx'
...
export const FetcherRouter = ({ fetcherName, params, ...other }) => {
  ...
  switch (fetcherName) {
    ...
    case 'usePlaceActionReportsNavData': {
      if (!params.projectId || !params.subprojectId || !params.placeId)
        return null
      return <PlaceActionReportsFetcher params={params} {...other} />
    }
    case 'usePlaceActionReportNavData': {
      if (
        !params.projectId ||
        !params.subprojectId ||
        !params.placeId ||
        ...
        return null
      return <PlaceActionReportFetcher params={params} {...other} />
    }
    case 'usePlaceActionReportReportNavData': {
      if (
        !params.projectId ||
        !params.subprojectId ||
        !params.placeId ||
        ...
        return null
      return <PlaceActionReportReportFetcher params={params} {...other} />
    }
    case 'usePlaceActionReportQuantitiesNavData': {
      if (
        !params.projectId ||
        !params.subprojectId ||
        !params.placeId ||
        ...
        return null
      return <PlaceActionReportQuantitiesFetcher params={params} {...other} />
    }
    case 'usePlaceActionReportQuantityNavData': {
      if (
        !params.projectId ||
        !params.subprojectId ||
        !params.placeId ||
        ...
        return null
      return <PlaceActionReportQuantityFetcher params={params} {...other} />
    }
    ...
    case 'useSubprojectHistoriesNavData': {
      if (!params.projectId || !params.subprojectId) return null
      return <SubprojectHistoriesFetcher params={params} {...other} />
    }
    case 'useSubprojectHistoryNavData': {
      if (
        ...
        return null
      return <SubprojectHistoryFetcher params={params} {...other} />
    }
    case 'usePlaceHistoriesNavData': {
      if (!params.projectId || !params.subprojectId || !params.placeId)
        return null
      return <PlaceHistoriesFetcher params={params} {...other} />
    }
    case 'usePlaceHistoryNavData': {
      if (
        ...
        return null
      return <PlaceHistoryFetcher params={params} {...other} />
    }
