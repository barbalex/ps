...
import { OwnLayer, type OwnLayerRow } from './OwnLayer.tsx'
...
export const OwnLayers = () => {
  ...
  const placeLevelsRes = useLiveQuery<PlaceLevels>(
  ...
  const ownVectorLayers = ((res?.rows ?? []) as unknown as OwnLayerRow[]).map(
    (l) => ({
      ...l,
