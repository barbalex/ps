...
// show it if:
// - the active table is places AND app_state.editing_place_geometry is the id of the active place
// - the active table is checks AND app_state.editing_check_geometry is the id of the active check
// - the active table is actions AND app_state.editing_action_geometry is the id of the active action
