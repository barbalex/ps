...
const seedPlaces = `INSERT INTO places(account_id, place_id, subproject_id, level, label, deleted) values ('018cf958-27e2-7000-90d3-59f024d467be', '018df4fa-cfb3-739c-bca2-d55dfe876995', '018cfd27-ee92-7000-b678-e75497d6c60e, 1, 'Demo Place 1', false);`
...
const seedCharts = `INSERT INTO charts(account_id, chart_id, chart_type, title, years_last_x, deleted) values ('018cf958-27e2-7000-90d3-59f024d467be', '018df502-138a-77bb-82b9-e5ab16c988ee', 'SimpleAreaChart', 'Test Title', 5, false);`
