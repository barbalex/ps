...
const seedChartSubjects = `INSERT INTO chart_subjects(account_id, chart_id, chart_subject_id, table_name, name, value_source, stroke, fill, connect_nulls, deleted) values 
('018cf958-27e2-7000-90d3-59f024d467be', '018df502-138a-77bb-82b9-e5ab16c988ee', '018df505-0d65-71a2-b214-76343bfc95cb', 'checks', 'Number of Checks', 'row_count', '#FF0000', '#ffffff', true, false),
('018cf958-27e2-7000-90d3-59f024d467be', '018df502-138a-77bb-82b9-e5ab16c988ee', '018df97e-905e-79b2-80a2-0cb3207a4aad', 'actions', 'Number of Actions', 'row_count', '#008000', '#ffffff', true, false);`
