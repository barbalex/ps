...
import { generateAccountLabel } from './sql/accounts'
import { generateFieldTypeLabel } from './sql/fieldTypes'
import { generateWidgetTypeLabel } from './sql/widgetTypes'
import { generateWidgetForFieldLabel } from './sql/widgetForField'
import { generateFileLabel } from './sql/files'
import { generatePlaceLevelLabel } from './sql/placeLevels'
import { generateUnitLabel } from './sql/units'
import { generateListLabel } from './sql/lists'
import { generateListValueLabel } from './sql/listValues'
import { generateTaxonomyLabel } from './sql/taxonomies'
import { generateTaxonLabel } from './sql/taxa'
import { generateProjectUserLabel } from './sql/projectUsers'
import { generateProjectReportLabel } from './sql/projectReports'
import { generateFieldLabel } from './sql/fields'
import { generatePersonLabel } from './sql/persons'
import { generatePlaceLabel } from './sql/places'
import { generatePlaceUserLabel } from './sql/placeUsers'
import { generateSubprojectTaxonLabel } from './sql/subprojectTaxa'
import { generateSubprojectReportLabel } from './sql/subprojectReports'
import { generateGoalLabel } from './sql/goals'
import { generateGoalReportLabel } from './sql/goalReports'
import { generateGoalReportValueLabel } from './sql/goalReportValues'
import { generateSubprojectUserLabel } from './sql/subprojectUsers'
import { generateCheckLabel } from './sql/checks'
import { generateCheckValueLabel } from './sql/checkValues'
import { generateCheckTaxonLabel } from './sql/checkTaxa'
import { generateActionLabel } from './sql/actions'
import { generateActionValueLabel } from './sql/actionValues'
import { generateActionReportLabel } from './sql/actionReports'
import { generateActionReportValueLabel } from './sql/actionReportValues'
import { generatePlaceReportLabel } from './sql/placeReports'
import { generatePlaceReportValueLabel } from './sql/placeReportValues'
import { generateMessageLabel } from './sql/messages'
import { generateAppStatesLabel } from './sql/appStates'
import { generateVectorLayerDisplayLabel } from './sql/vectorLayerDisplays'
import { generateChartLabel } from './sql/charts'
import { generateChartSubjectLabel } from './sql/chartSubjects'
import { generateOccurrenceImportLabel } from './sql/occurrenceImports'
