...
import { PlaceActionReportQuantitiesNode } from './PlaceActionReportQuantities.tsx'
...
export const PlaceActionReportNode = ({
  ...
  const res = useLiveQuery(
    `SELECT place_action_report_quantities, place_action_report_quantities_in_report
     FROM place_levels
    ...
    <>
      ...
      {isOpen && (
        <>
          ...
          />
          {(isDesigning ||
            placeLevel?.place_action_report_quantities !== false) && (
