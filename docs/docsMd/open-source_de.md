...
arten-fördern.app wird (bisher nur) von [Gabriel-Software](https://gabriel-software.ch) entwickelt.

Der Code ist [open source](https://github.com/barbalex/ps/blob/main/LICENSE). Es steht dir frei, ihn zu kopieren und die App selber zu betreiben.
...
Aus egoistischer Sicht vielleicht. Ich bin aber überzeugt, dass Code dauernd unterhalten und weiter entwickelt werden muss. Eine App muss sich ständig den Bedürfnissen ihrer Benutzer anpassen und sich vorausschauend weiter entwickeln. Ansonsten ist sie tot. Ein Projekt, dass auf einer toten App aufbaut, stagniert. Aus Sicht der Benutzer und Auftraggeber heisst das auch: Mich nachhaltig finanzieren lohnt sich. Habe ich dich überzeugt?
