...
I still do not have a full overview of which data from an online payment may be accessible to me. But I am not interested in it, in the sense that I do not want it. Because I do not need to know who you are: as long as you pay in advance, you can use arten-fördern.app. If you stop paying, that is a pity, and I would be very interested to know what I should improve. But I do not have to chase unpaid invoices.

How high these subscription fees will be has not yet been decided.

The usual Software as a Service business model works like this: attract customers with low or no fees, build a monopoly in an early phase, or at least make customers dependent. Then raise prices and CASH IN.

I dislike that.

A fair model starts from how many customers are likely to subscribe and can therefore estimate which prices make the model sustainable.

The difficult part is that this is hard to estimate. So I will define amounts and review them every year depending on demand. My intention is to communicate as transparently as possible, so that you can also estimate how things are going.

For example, I can imagine showing account users a rough statistic: number of accounts per type.
