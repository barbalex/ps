...
arten-fördern.app vous indique en haut à droite avec l'icône nuage si vous êtes en ligne ou hors ligne.

arten-fördern.app **synchronise** toutes vos données depuis le serveur dans sa propre base de données locale. Vous pouvez donc continuer à travailler hors ligne sans problème.

## Les opérations s'accumulent

Lorsque vous travaillez, arten-fördern.app regroupe vos nouvelles données en petits « paquets » appelés opérations.
