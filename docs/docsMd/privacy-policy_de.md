...
Backblaze dient als zusätzliche Rückversicherung, als drittes Backup Ihrer Daten (erste: kurzfristige Droplet-Sicherung auf Netlify, zweite: Nächtliche Daten-Sicherung auf unserem eigenen Server im Büro). Die Daten sind Ende zu Ende verschlüsselt - Backblaze kann sie daher nicht lesen.
...
Unsere Vertragspartner und Mitarbeitenden, die Zugang zu Ihren Daten haben, sind zur Einhaltung der datenschutzrechtlichen Bestimmungen verpflichtet. Es ist prinzipiell denkbar (aber aktuell nicht vorgesehen) im Rahmen der Auftragsverarbeitung Ihre Anfragen an mit uns verbundene Unternehmen weiterreichen. Auch in diesen Fällen werden Ihre Daten vertraulich behandelt.

Innerhalb unserer Web-Applikation verwenden wir das SSL-Verfahren (Secure Socket Layer) in Verbindung mit der jeweils höchsten Verschlüsselungsstufe, die von Ihrem Browser unterstützt wird.

## 7 Betroffenenrechte

### Auskunftsrecht

Sie können jederzeit eine Auskunft, über die von uns über Sie gespeicherten Daten verlangen. Wir bitten Sie, Ihr Auskunftsgesuch zusammen mit einem glaubhaften Identitätsnachweis an alex@gabriel-software.ch zu senden.
...
### 8.1 Welche Daten verarbeiten wir von Ihnen und von wem erhalten wir diese Daten?

In erster Linie verarbeiten wir personenbezogene Daten, die Sie uns übermitteln oder die wir beim Betrieb unserer Web-Applikation erheben. Andere Daten sind aktuell nicht vorgesehen.

Prinzipiell könnten wir auch personenbezogene Daten über Sie auch von Dritten erhalten. Das könnten folgende Kategorien sein:
...
### 8.2 Unter welchen Voraussetzungen verarbeiten wir Ihre Daten?
...
Sie können Ihre erteilte Einwilligung für die Zukunft jederzeit widerrufen und eine E-Mail an alex@gabriel-software.ch schicken. Bereits erfolgte Datenverarbeitungen sind von dem Widerruf nicht betroffen und behalten ihre Gültigkeit.

### 8.4 In welchen Fällen geben wir Ihre Daten an Dritte weiter?
...
### 8.5 Wie lange bewahren wir Ihre Daten auf?
...
Indem Sie arten-fördern.app lediglich besuchen, sich also nicht registrieren oder anderweitige Informationen preisgeben, werden nur die Daten erhoben, die Ihr Browser an unseren Server automatisiert übermittelt.
...
Die Daten werden nur so lang gespeichert, wie dies zur Erreichung des Zweckes ihrer Erhebung notwendig ist. Dementsprechend werden die Daten nach Beendigung jeder Sitzung gelöscht. Die Speicherung der Logfiles ist für den Betrieb der Web-Applikation zwingend notwendig, Sie haben daher keine Möglichkeit, dagegen Widerspruch zu erheben, es sei denn Sie besuchen arten-fördern.app nicht.

### 9.2 Cookies

Bei Cookies handelt es sich um Daten, die mit Hilfe des Browsers auf dem Betriebssystem Ihres Gerätes abgelegt werden, wenn Sie arten-fördern.app aufrufen. Wenn Sie sich anmelden werden alle Ihre Projektdaten auf eine Lokale Datenbank in Ihrem Browser synchronisiert - das fällt wohl auch unter den Begriff der Cookies. Cookies richten auf Ihrem Rechner keinen Schaden an (ausser Speicherbelegung) und enthalten keine Viren. Die verwendeten Cookies sind technisch notwendig, damit arten-fördern.app ihre Funktion erfüllen kann. Darüber hinaus speichern wir nichts. Unsere Cookies bleiben auf Ihrem Endgerät gespeichert, bis Sie diese löschen oder deren Laufzeit abläuft.

#### Zu welchem Zweck verarbeiten wir die Daten?

Die bei Ihnen lokal gespeicherten Daten dienen der Funktion, für die Sie arten-fördern.app benutzen. Darüber hinaus speichern wir nichts, insbesondere keine Third Party Cookies.
...
Cookies werden auf Ihrem Rechner gespeichert. Sie können diese vollständig löschen oder durch Änderung der Einstellungen in Ihrem Browser die Übertragung deaktivieren oder einschränken. Bei Deaktivierung von Cookies funktioniert arten-fördern.app nicht mehr (nur die Homepage und die Dokumentation).
...
Wir können diese Datenschutzerklärung jederzeit ändern. Die Änderungen werden auf arten-fördern.app veröffentlicht. Sie werden nicht gesondert informiert.
