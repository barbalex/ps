...
Le esportazioni consentono di:

1. Esportare parti dei dati
2. Generare query personalizzate

Formati:

- .csv (semplice, universalmente utilizzabile)
- .ods (per documenti foglio di calcolo)
- .xlsx (per documenti foglio di calcolo)
