...
5. Isn't it foolish to give up control? From a selfish perspective, perhaps. But I am convinced that code that is not constantly maintained and further developed is dead. An app that does not constantly adapt to the needs of its users and develop proactively loses its raison d'être. From the perspective of users and clients, this also means: sustainably funding me is worthwhile. Have I convinced you?
