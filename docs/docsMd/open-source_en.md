...
arten-fördern.app is developed by [Gabriel-Software](https://gabriel-software.ch).

The code is [open source](https://github.com/barbalex/ps/blob/main/LICENSE). Everyone is free to copy it and run the app themselves.
...
5. Isn't it foolish to give up control? From a selfish perspective, perhaps. But I am convinced that code must be maintained and continuously developed. An app must constantly adapt to the needs of its users and proactively evolve. Otherwise, it is dead. A project built on a dead app stagnates. From the perspective of users and clients, this also means: sustainably funding me is worthwhile. Have I convinced you?
