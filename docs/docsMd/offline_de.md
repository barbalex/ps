...
arten-fördern.app zeigt dir oben rechts mit dem Wolken-Symbol an, ob du on- oder offline bist.

arten-fördern.app **synchronisiert** alle deine Daten vom Server in die eigene Datenbank. Darum kannst du offline einfach weiter arbeiten.

## Operationen stehen Schlange

Wenn du arbeitest, packt arten-fördern.app deine neuen Daten in "Päckchen", Operationen genannt.

Online werden diese Operationen umgehend dem Server geschickt und stehen sofort allen anderen Mitarbeitern zur Verfügung.

Offline stehen die Operationen geduldig an. Bis du wieder online bist. Dann werden sie umgehend zum Server geschickt.

Wieviele Operationen gerade anstehen, siehst du an der kleinen Zahl oben rechts des Wolken-Symbols (nur wenn du offline bist).

Sobald Operationen anstehen, werden sie im Navigations-Baum unten links sichtbar. Dort könntest du wenn nötig einzelne oder alle Operationen löschen. Aber das willst du vermutlich nicht, denn damit gingen sie verloren.
