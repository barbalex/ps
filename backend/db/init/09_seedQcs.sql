...
ORDER BY f.label'),
('Ort-Felder ohne Stufe', 'Place fields without level', 'Champs de lieu sans niveau', 'Campi di luogo senza livello', true, false, false, false, NULL),
...
ORDER BY a.label'),
('Ort-Bericht-Mengen: Standard-Einheit nicht verwendet', 'Place report quantities: default unit not used', 'Quantités de rapport de lieu : unité par défaut non utilisée', 'Quantità di rapporto di luogo: unità predefinita non utilizzata', false, false, true, false, NULL),
